...
def run_single_scenario(scenario):
    ...
    # New native methods (NetworkX implementations)
    try:
...
#Feb12 BUG: zero memory usage issue
...
#     # Measure each in a try/except to ensure we can skip gracefully on failure
#     try:
...
#     # Measure the two new native Nx methods
#     try:
#         gnxp, gnxt, gnxm = measure_method(run_girvan_newman_nx, G)
#     except:
#         pass
#     try:
#         lnxp, lnxt, lnxm = measure_method(run_louvain_nx, G)
#     except:
#         pass
...
if __name__ == "__main__":
    ...
    # Updated fieldnames with GNX_*, LNX_*
    fnames = [
