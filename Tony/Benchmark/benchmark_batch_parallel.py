...
if __name__ == "__main__":
    ...
    p_in_values = [0.01, 0.02, 0.05, 0.10, 0.15]   
    p_out_values = [0.001, 0.005, 0.01, 0.02, 0.05]
    ...
    for (sizes, probs) in sbm_param_grid:
        ...
        name = (f"SBM_{len(sizes)}blocks_{total_nodes}nodes_"
                f"pin{probs[0][0]:.3f}_pout{probs[0][1]:.3f}")
