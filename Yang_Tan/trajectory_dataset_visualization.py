...
# Define the base directory containing user folders (adjust this path)
base_dir = "Data/"  # Replace with the actual path
...
for user_id in range(0, 182):  # User folders range from 000 to 182
    folder_path = os.path.join(base_dir, f"{user_id:03d}")  # Format user_id as '000', '001', etc.
    
    # Find all .plt files in the folder
...
# Save the map
m.save("user_trajectories_map.html")